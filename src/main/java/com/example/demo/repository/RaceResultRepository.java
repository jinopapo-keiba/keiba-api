...
public interface RaceResultRepository {
    ...
    List<BestRaceTime> fetchBestRaceTimes(@Param("stadium") String stadium, @Param("raceLength") Integer raceLength, @Param("raceId") String raceId,@Param("summaryType") SummaryType summaryType);
}
